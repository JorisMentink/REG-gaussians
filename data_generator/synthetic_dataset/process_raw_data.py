...
def main(args):
    ...
    print("Loaded metadata path:", metadata_path)
    ...
    for i_case in pbar:
        ...
        if not osp.exists(case_output_path):
            ...
            elif file_type == "raw" or file_type == "img": #ADDED TO ACCEPT 
...
if __name__ == "__main__":
    ...
    parser.add_argument("--metadata", default="data_generator/synthetic_dataset/raw_metadata.py", type=str, help="Path to metadata.")
